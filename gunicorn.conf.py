...
def on_starting(server):
    ...
    #server.log.access_log.addFilter(RequestPathFilter(path_re=r'^/etd/version'))
...
if not os.path.exists(f'/home/etdadm/logs/etd-dash-service/{container_id}'):
    os.makedirs(f'/home/etdadm/logs/etd-dash-service/{container_id}')
...
logconfig_dict = {
    ...
    "handlers": {
        "error_console": {
            ...
            "filename": f"/home/etdadm/logs/etd-dash-service/{container_id}/error_console_{container_id}_{timestamp}.log",
            "mode": "a"
        },
        "console": {
            "class": "logging.FileHandler",
            "formatter": "json_formatter",
            "filename": f"/home/etdadm/logs/etd-dash-service/{container_id}/console_{container_id}_{timestamp}.log",
            "mode": "a"
        }
    },
    "loggers": {
